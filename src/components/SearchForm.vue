...
export default {
  ...
  methods: {
    ...
    GetCarparks: async function (lat, lng) {
      ...
      // );
      urls.push("https://bt3103-assignment.web.app/ltaodataservice/CarParkAvailabilityv2");
      urls.push(
        "https://bt3103-assignment.web.app/ltaodataservice/CarParkAvailabilityv2?$skip=500"
      );
      urls.push(
        "https://bt3103-assignment.web.app/ltaodataservice/CarParkAvailabilityv2?$skip=1000"
      );
      urls.push(
        "https://bt3103-assignment.web.app/ltaodataservice/CarParkAvailabilityv2?$skip=1500"
      );
      urls.push(
        "https://bt3103-assignment.web.app/ltaodataservice/CarParkAvailabilityv2?$skip=2000"
      );
